...
namespace Portal.Service.Implements
{
    public class BannerService : IBannerService
    {
        public IList<BannerViewModel> GetBanners1ForHomePage()
        {
            ...
            {
                return db.system_Banners.Where(x => x.Status == (int)Portal.Infractructure.Utility.Define.Status.Active && x.Type == (int)Portal.Infractructure.Utility.Define.BannerTypes.Banner1)

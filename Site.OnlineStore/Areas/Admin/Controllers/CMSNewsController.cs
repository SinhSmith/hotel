...
namespace Site.OnlineStore.Areas.Admin.Controllers
{
    public class CMSNewsController : BaseManagementController
    {
        ...
        {
            int totalItems = 0;
            var categories = _cmsNewsService.GetCMSNews(page, Portal.Infractructure.Utility.Define.PAGE_SIZE, out totalItems);

            IPagedList<CMSNewsView> pageNews = new StaticPagedList<CMSNewsView>(categories, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, totalItems);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            PopulateStatusDropDownList((Portal.Infractructure.Utility.Define.Status)news.Status);
            return View(news);
        }

...
namespace Site.OnlineStore.Areas.Admin.Controllers
{
    public class ProfileController : BaseManagementController
    {
        ...
        {
            int totalItems = 0;
            var profiles = _profileService.GetProfiles(page, Portal.Infractructure.Utility.Define.PAGE_SIZE, out totalItems);

            IPagedList<ProfileViewModel> pageProfiles = new StaticPagedList<ProfileViewModel>(profiles, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, totalItems);

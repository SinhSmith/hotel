...
namespace Site.OnlineStore.Areas.Admin.Controllers
{
    public class CMSCategoryController : BaseManagementController
    {
        ...
        {
            int totalItems = 0;
            var categories = _cmsCategoryService.GetCMSCategories(page, Portal.Infractructure.Utility.Define.PAGE_SIZE, out totalItems);
            ...
            IPagedList<CMSCategoryView> pageCategories = new StaticPagedList<CMSCategoryView>(availableCategories, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, totalItems);

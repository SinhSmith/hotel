...
namespace Site.OnlineStore.Areas.Admin.Controllers
{
    public class BannerController : BaseManagementController
    {
        ...
        {
            int totalItems = 0;
            var banners = _bannerService.GetBanners(page, Portal.Infractructure.Utility.Define.PAGE_SIZE, out totalItems);

            IPagedList<BannerViewModel> pageBanners = new StaticPagedList<BannerViewModel>(banners, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, totalItems);

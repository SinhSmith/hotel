...
namespace Site.OnlineStore.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int? id, int page = 1)
        {
            ...
            int totalItems = 0;
            var news = _cmsNewsService.GetCMSNewsByCategoryId(id.Value, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, out totalItems);
            IPagedList<CMSNewsView> pageNews = new StaticPagedList<CMSNewsView>(news, page, Portal.Infractructure.Utility.Define.PAGE_SIZE, totalItems);
